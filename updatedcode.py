...
jet_skins = {
    "Default": jet_img,
    "Red Jet": pygame.transform.scale(pygame.image.load("red_jet.png"),(jetsize*2,jetsize*2)),
    "yellow Jet": pygame.transform.scale(pygame.image.load("yellow_jet.png"),(jetsize*2,jetsize*2))
}
